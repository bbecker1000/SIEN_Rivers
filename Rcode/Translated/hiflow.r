...
for (n in 1:recdyr){
        ...
        for (m in tma:tmb){
            ...
            hq7d <- (dmq[[m]]+dmq[[m-1]]+dmq[[m-2]]+dmq[[m-3]]+dmq[[m-4]]+dmq[[m-5]]+dmq[[m-6]])/7
            hq10d <- (dmq[[m]]+dmq[[m-1]]+dmq[[m-2]]+dmq[[m-3]]+dmq[[m-4]]+dmq[[m-5]]+dmq[[m-6]]+dmq[[m-7]]+dmq[[m-8]]+dmq[[m-9]])/10
            hq14d <- (dmq[[m]]+dmq[[m-1]]+dmq[[m-2]]+dmq[[m-3]]+dmq[[m-4]]+dmq[[m-5]]+dmq[[m-6]]+dmq[[m-7]]+dmq[[m-8]]+dmq[[m-9]]+dmq[[m-10]]+dmq[[m-11]]+dmq[[m-12]]+dmq[[m-13]])/14
            if (hq3d > hi3df[[n]]){
                hi3df[n] <- hq3d
                mhi3df[n] <- m - (mindys - 1)
            }
        ...
        xxp <- list(0.98, 0.95, 0.90, 0.80, 0.70, 0.6, 0.50, 0.3333, 0.20,
...
for (n in 1:recdyr){
    cat(
        sprintf(
            '#7.f #8.2f #8.2f #8.2f #8.2f #8.2f #8.2f\n',
            wyr[n],
            hi3df[n],
            hi7df[n],
            hi10df[n],
