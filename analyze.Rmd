...
```{r}
inputFile <- NULL # Set to appropriate file
usgs <- FALSE # Set to true if the input is in USGS format
defaultFile <- './Rcode/MRHq.txt'
data <- readData(if (is.null(inputFile)) defaultFile else inputFile, usgs = usgs)
```
